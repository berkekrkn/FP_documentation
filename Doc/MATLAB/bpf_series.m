...
freqs = ["0.01", "10", "17.5", "25", "100"];
allfreqs = ["1e-6", "1e-5", "0.0001", "0.001", "0.01", "0.1", "1", "5", ...
            "10", "15" , "17", "19", "20", "22", "25", "30", "50", "100", "250", ... 
            "500", "1000", "2000", "3000"];
N = length(freqs);
freqstr = "(f=" + freqs + ")";

%% Bpf
pe = "data/fields/bpfs/e/";
...
pe = "data/fields/bpfs/e30/";
e = dir(fullfile(pe,'*.txt'));  
ph = "data/fields/bpfs/h30/";
h = dir(fullfile(ph,'*.txt'));
...
bpfs_s11 = readmatrix("data/fields/bpfs/bpf_series_s11.txt");
bpfs_s21 = readmatrix("data/fields/bpfs/bpf_series_s21.txt");
freq11 = bpfs_s11(:,1);
freq21 = bpfs_s21(:,2);
magS11 = bpfs_s11(:,2);
magS21 = bpfs_s21(:,2);
