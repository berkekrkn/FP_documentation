...
freqs = ["0.001", "1", "5", "20", "100"];
allfreqs = ["1e-6", "1e-5", "0.0001", "0.001", "0.01", "0.1", "1", ...
            "2.5", "4" , "4.5", "5", "5.5", "7.5", "10", "25", "50", ... 
            "100", "250", "500", "1000", "2000", "3000"];
N = length(freqs);
freqstr = "(f=" + freqs + ")";

%% Bpf
pe = "data/fields/wilkinson/e/";
...
pe = "data/fields/wilkinson/e30/";
e = dir(fullfile(pe,'*.txt'));  
ph = "data/fields/wilkinson/h30/";
h = dir(fullfile(ph,'*.txt'));
...
wilkinson_s11 = readmatrix("data/fields/wilkinson/wilkinson_s11.txt");
wilkinson_s21 = readmatrix("data/fields/wilkinson/wilkinson_s21.txt");
wilkinson_s31 = readmatrix("data/fields/wilkinson/wilkinson_s31.txt");
freq11 = wilkinson_s11(:,1);
freq21 = wilkinson_s21(:,2);
freq31 = wilkinson_s31(:,2);
magS11 = wilkinson_s11(:,2);
magS21 = wilkinson_s21(:,2);
magS31 = wilkinson_s31(:,2);
figure;
hold on;
plot(freq11, magS31, 'LineWidth', 1.5);
...
xlim([0 10]);
xlabel('Frequency, f in MHz');
ylabel('Magnitude of S-parameters in dB');
xticks(0:1:10);
yticks(-30:5:0);
legend("|S_{31}|", "|S_{21}|", "|S_{11}|", 'location', 'best');
