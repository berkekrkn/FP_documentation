...
%% Loop current vs freq
loop_current = readmatrix("data/fields/loop/loop_curr.txt");
freq = loop_current(:,1);
magI = loop_current(:,2);
figure;
...
xticks(0:500:3000);
%% Loop S11 vs freq
loop_s11 = readmatrix("data/fields/loop/loop_s11.txt");
freq = loop_s11(:,1);
s11 = loop_s11(:,2);
figure;
